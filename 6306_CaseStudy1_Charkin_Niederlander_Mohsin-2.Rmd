...
barplot(ABV, las=2, ylab = "ABV", main = "ABV Content by State", cex.names=0.7)

IBU<-tapply (merged$IBU, merged$State, median, na.rm = TRUE)
barplot(IBU, las=2, ylab = "IBU", main = "IBU Content by State", cex.names=0.7)
```
...
```{r}
plot(merged$IBU, merged$ABV, xlab = "IBU",ylab="ABV", main = "ABV to IBU Scatterplot")
